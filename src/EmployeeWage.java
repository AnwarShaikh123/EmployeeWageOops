public class EmployeeWage {
    ...
    public EmployeeWage(String company, int EMP_RATE_PER_HOUR, int EMP_WORK_DAYS, int EMP_WORK_HOUR) {
    ...
    public static void main(String[] args) {
        ...
        EmployeeWage emp1 = new EmployeeWage("Samsung", 300, 25, 250);
        emp1.calculateEmployeeWage();
        System.out.println(emp1);

        EmployeeWage emp2 = new EmployeeWage("Apple", 500, 29, 350);
